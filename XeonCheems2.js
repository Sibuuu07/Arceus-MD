...
//© 2022 Xeon Bot Inc. Arceus Bot MD
...
const reply = (teks) => {
            XeonBotInc.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": ` ${global.botname}`,"body": ` Join Bot's Official GC`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./XeonMedia/cheemspic.jpg`),"sourceUrl": "https://chat.whatsapp.com/Kb6msWfU8fP25KcG3M4Xtw"}}}, { quoted: m})
        }
...
☣️ Url : ${anu.url}`,
	    ...
	    case 'ytmp3': case 'getmusic': case 'ytaudio': {
                ...
                XeonBotInc.sendImage(m.chat, media.thumb, `☣️ Title : ${media.title}\n☣️ File Size : ${media.filesizeF}\n☣️ Url : ${isUrl(text)}\n☣️ Ext : MP3\n☣️ Resolution : ${args[1] || '320kbps'}`, m)
            ...
            case 'ytmp4': case 'getvideo': case 'ytvideo': {
                ...
                if (media.filesize >= 999999) return reply('File Over Limit '+util.format(media))
                XeonBotInc.sendMessage(m.chat, { video: { url: media.dl_link }, mimetype: 'video/mp4', fileName: `${media.title}.mp4`, caption: `☣️ Title : ${media.title}\n☣️ File Size : ${media.filesizeF}\n☣️ Url : ${isUrl(text)}\n☣️ Ext : MP3\n☣️ Resolution : ${args[1] || '360p'}` }, { quoted: m })
            }
            break
	    case 'getmusicxxx': {
                let { yta } = require('./lib/y2mate')
		...
		let { pinterest } = require('./lib/scraper')
                ...
                XeonBotInc.sendMessage(m.chat, { image: { url: result }, caption: '☣️ Media Url : '+result }, { quoted: m })
            }
            break
case 'webtonsearch': case 'webtoon':
	    ...
	    case 'nomerhoki': case 'nomorhoki': {
            ...
            case 'artinama': {
                ...
                if (anu.status == false) return reply(anu.message)
                XeonBotInc.sendText(m.chat, `☣️ *Name :* ${anu.message.nama}\n☣️ *Meaning :* ${anu.message.arti}\n☣️ *Notes :* ${anu.message.catatan}`, m)
            }
            break
            ...
            case 'jadianpernikahan': case 'jadiannikah': {
                ...
                if (anu.status == false) return reply(anu.message)
                XeonBotInc.sendText(m.chat, `☣️ *Wedding Date :* ${anu.message.tanggal}\n☣️ *Characteristics :* ${anu.message.karakteristik}`, m)
            }
            break
            case 'sifatusaha': {
                ...
                if (anu.status == false) return reply(anu.message)
                XeonBotInc.sendText(m.chat, `☣️ *Born :* ${anu.message.hari_lahir}\n☣️ *Business :* ${anu.message.usaha}`, m)
            }
            break
            ...
            case 'artitarot': case 'tarot': {
                ...
                if (anu.status == false) return reply(anu.message)
                XeonBotInc.sendImage(m.chat, anu.message.image, `☣️ *Born :* ${anu.message.tgl_lahir}\n☣️ *Tarot Symbol :* ${anu.message.simbol_tarot}\n☣️ *Meaning :* ${anu.message.arti}\n☣️ *Notes :* ${anu.message.catatan}`, m)
            }
            break
            case 'fengshui': {
            ...
            case 'memancing': {
                ...
                if (anu.status == false) return reply(anu.message)
                XeonBotInc.sendText(m.chat, `☣️ *Date :* ${anu.message.tgl_memancing}\n☣️ *Results :* ${anu.message.result}\n☣️ *Notes :* ${anu.message.catatan}`, m)
            }
            break
            case 'masasubur': {
                ...
                if (anu.status == false) return reply(anu.message)
                XeonBotInc.sendText(m.chat, `☣️ *Results :* ${anu.message.result}\n☣️ *Notes :* ${anu.message.catatan}`, m)
            }
            break
            ...
            case 'shio': {
                ...
                if (anu.status == false) return reply(anu.message)
                XeonBotInc.sendText(m.chat, `☣️ *Results :* ${anu.message}`, m)
            }
            break
		...
		case 'igeh': case 'instagram2x': case 'ig2': case 'igdl2': {
            ...
            case 'soundcloud': case 'scdl': {
                ...
                let msg = await XeonBotInc.sendImage(m.chat, anu.result.thumb, `☣️ Title : ${anu.result.title}\n☣️ Url : ${isUrl(text)[0]}`)
	        ...
	        case 'fbdlx': case 'fbx': case 'facebookx': {
                ...
                XeonBotInc.sendMessage(m.chat, { video: { url: anu.result.url }, caption: `☣️ Title : ${anu.result.title}`}, { quoted: m })
            }
            break
...
`,
		    ...
		    anu.media.map(async (url) => {
		        XeonBotInc.sendMessage(m.chat, { image: { url }, caption: `☣️ Title : ${anu.title}\n☣️ Author : ${anu.author.name}\n☣️ Like : ${anu.like}\n☣️ Caption : ${anu.caption}` }, { quoted: m })
		    })
		}
	    }
	    break
...
break
                    case 'bug': case 'report': {
                    	...
                    	XeonBotInc.sendMessage(`919337956084@s.whatsapp.net`, {text: `*Bug Report From:* wa.me/${m.sender.split("@")[0]}
Report Message: ${text}` })
...
let template = await generateWAMessageFromContent(m.chat, proto.Message.fromObject({
    ...
    case 'donasi': case 'donate': case 'sewabot': case 'sewa': case 'buypremium': case 'donate': {
                XeonBotInc.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/12493a57962e154fb6056.jpg' }, caption: `*Hi Bro ${m.pushName}*\n\nBot Group: \n♨️Link : https://chat.whatsapp.com/Kb6msWfU8fP25KcG3M4Xtw` }, { quoted: m })
            }
            break
            case 'sc': case 'script': {
                reply(`GitHub : https://github.com/sibuuuu07/ArctixBot-MD\n Dont Forget To Give Star\n\nInstagram : ${myweb}\nDont Forget To Follow`)
            }
            break
case 'allmenu': {
  	anu = `
...
┃╠ ${prefix}report [bug]
┃╚═════════════✪
┗━━「 ${pushname} 」━⭓`,unicorn, [{"urlButton": {"displayText": "YouTube 📍","url": `${myweb}`}},{"urlButton": {"displayText": "Script🔖","url": `${sc}`}},{"quickReplyButton": {"displayText": "🧧Bot Group🧧","id": 'donate'}},{"quickReplyButton": {"displayText": "👤Owner👤","id": 'owner'}}] )
break
...
┃╠${prefix}delvote
┃╚═════════════✪
┗━━「 ${pushname} 」━⭓`,unicorn, [{"urlButton": {"displayText": "Instagram📸 ","url": `${myweb}`}},{"urlButton": {"displayText": "Script🔖","url": `${sc}`}},{"quickReplyButton": {"displayText": "🧧Bot Group🧧","id": 'donate'}},{"quickReplyButton": {"displayText": "👤Owner👤","id": 'owner'}}] )
break
...
Xeon (Me)
My family
And All Friends Who Helped Assemble This Sexy Script !!!`,unicorn, [{"urlButton": {"displayText": "Instagram📸 ","url": `${myweb}`}},{"urlButton": {"displayText": "Script🔖","url": `${sc}`}},{"quickReplyButton": {"displayText": "🧧Bot Group🧧","id": 'donate'}},{"quickReplyButton": {"displayText": "👤Owner👤","id": 'owner'}}] )
break
            default:
                if (budy.startsWith('=>')) {
